    ...
    while(1)
    {
        ...
        switch(g_cur_state)
        {
            case 0x01:                                 //正常模式
                ...
                {
                    if(g_keypress_maxtime >= 5)       //判断吸烟超过10s情况
                    {
                        DUTY(MOS_OFF);
                    ...
                    else
                    {
                        ...
                        {
                            if(g_batteryvolt >= VBAT38)
                            {
                                if(g_batteryvolt >= VBAT39)
                                {
                                    if(g_batteryvolt >= VBAT40)
                                    {
                                        if(g_batteryvolt >= VBAT41)
                                        {
                                            DUTY(MOS_41_42);
                                        }
                                        else
